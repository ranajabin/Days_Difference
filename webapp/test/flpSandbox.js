		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#calculatedate1calculatedateproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"calculatedate1calculatedateproject-display": {
								"semanticObject": "calculatedate1calculatedateproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=calculatedate1.calculatedateproject",
									"url": sap.ui.require.toUrl("calculatedate1/calculatedateproject")
								}
							}
						}
					}
